...
package io.dhiren.designpatterns.singleton;
...
public class MySingleton implements Serializable {
    ...
    private MySingleton() {
		// make io.dhiren.designpatterns.singleton class safe from reflection
        if (instance != null) {
    ...
    public static MySingleton getInstance() {
		// make io.dhiren.designpatterns.singleton class safe from multiple threads
        if (instance == null) {
            synchronized (MySingleton.class) {
				// make io.dhiren.designpatterns.singleton class doubly locked
                if (instance == null)
    ...
    // make io.dhiren.designpatterns.singleton class safe from serialization
